...
-- Policy: viewable by everyone
do $$ begin
  create policy "Rescue orgs are viewable by everyone"
...
drop trigger if exists update_rescue_orgs_updated_at on public.rescue_orgs;
create trigger update_rescue_orgs_updated_at
...
-- Policy: viewable by everyone
do $$ begin
  create policy "Safety guidelines are viewable by everyone"
...
drop trigger if exists update_safety_guidelines_updated_at on public.safety_guidelines;
create trigger update_safety_guidelines_updated_at
